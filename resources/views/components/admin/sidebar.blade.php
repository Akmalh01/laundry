<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header d-flex justify-content-center align-items-center">
        ...
        <a class="navbar-brand m-0" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html"
            target="_blank">
            <img src="{{ asset('assets/img/laundry.png') }}" class="navbar-brand-img logo-lg" alt="main_logo">
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link  " href="{{ url('/admin/paket') }}">
                    ...
                    <span class="nav-link-text ms-1">Manajemen Paket Layanan</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  " href="{{ url('/admin/diskon') }}">
                    ...
                    <span class="nav-link-text ms-1">Manajemen Diskon</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  " href="{{ url('/admin/laporan') }}">
                    ...
                    <span class="nav-link-text ms-1">Laporan & Monitoring</span>
                </a>
            </li>
            <li class="nav-item">
    ...
    <div class="sidenav-footer mx-3 ">
        ...
        <a class="btn btn-primary mt-3 w-100"
            href="https://www.creative-tim.com/product/soft-ui-dashboard-pro?ref=sidebarfree">Logout</a>
    </div>
</aside>
